...
## ⚠️ Compatibility and Disclaimer
...
1. Go to the **Releases** tab and download the `FanControl-1.0.pkg` file.
...
git clone [https://github.com/your-username/FanControl.git](https://github.com/your-username/FanControl.git)
cd FanControl
